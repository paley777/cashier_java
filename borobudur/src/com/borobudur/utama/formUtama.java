...
package com.borobudur.utama;

import com.borobudur.koneksi.koneksi;
...
public class formUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Nama Paket Tiket");
        ...
        transaksi.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 186, -1, 20));
        ...
        transaksi.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, -1, -1));
        ...
        jLabel8.setFont(new java.awt.Font("Friz Quadrata", 0, 18)); // NOI18N
        jLabel8.setText("Sistem Manajemen Tiket");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 360, 35));

        jLabel9.setFont(new java.awt.Font("Friz Quadrata", 0, 18)); // NOI18N
        jLabel9.setText("Objek Wisata Candi Borobudur");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 360, 35));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Connection con = koneksi.getConnection();
            String NamaFile = "/com/borobudur/report/Struk_Pembayaran.jasper";
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        Connection con = koneksi.getConnection();
            String NamaFile = "/com/borobudur/report/laporan_penjualan.jasper";
            HashMap hash = new HashMap();
        try {
